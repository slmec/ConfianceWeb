        ...
        <section>
            <div class="container">
                <header>
                    ...
                    <div class="middle">
                        <nav class="navbar">
                            ...
                            <a href="Controleur/critere.php">Base théorique</a>
                            <a href="Controleur/guide.php">Fonctionnement</a>
                            <a href="Controleur/projet.php">Equipes et partenaires</a>
                            <a href="Controleur/identification.php" target="_blank">Accès à l'outil</a>
                        </nav>
                    </div>
                    <div class="right">
                ...
                <div class="maiat">
                    ...
                    <p>De nombreux travaux appr&eacute;hendent le d&eacute;ploiement de l&rsquo;IA dans les organisations et les m&eacute;tiers.&nbsp;Au-del&agrave; des dynamiques destructions/
