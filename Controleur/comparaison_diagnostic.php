 ...
 ?>
    ...
    <script>
        ...
        const radarChart = new Chart(radarCanvas,{
            ...
            <h1> Recapitulatif Diagnostic <?php echo $diagnostic1_nom ?> </h1>
        <?php
    ...
    <script>
        ...
        $row1 = mysqli_fetch_assoc($resultat1); ?>
            ...
            <table>
                ...
                <tr>
                    <td> Diagnostic <?php echo $diagnostic1_nom ?></td>
                </tr>
                <tr>
                    <td> Vos réponses </td>
                    <td><?php if ($row['C1Q1'] == 0) {echo 'Oui';} else {echo 'Non';} ?></td>
                ...
                <tr>
                    <td> Diagnostic <?php echo $diagnostic2_nom ?></td>
                </tr>
                <tr>
                    <td> Vos réponses </td>
    ...
    <table>
        ...
        <tr>
            <td> Diagnostic <?php echo $diagnostic3_nom ?></td>
        </tr>
        <tr>
            <td> Vos réponses </td>
