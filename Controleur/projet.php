                ...
                <header>
                    ...
                    <div class="middle">
                        <nav class="navbar">
                            ...
                            <a class="active" href="projet.php">Equipes et partenaires</a>
                    ...
                    <div class="bottom">
                        ...
                        <div class="bottom-bottom">
                            <p class="bottom-bottom-center">L'Icam est une école d'ingénieur généraliste. L'équipe dirigée par Yann Ferguson, chercheur leader en Intelligence Artificielle et expert au GPAI,
                                a conçu MAIAT afin d'accompagner les entreprises dans la qualification des risques sociaux liés à l'intégration de l'IA au travail. La collaboration avec
                                Renault et Spix Industry a permis d'expérimenter cet outil.</p>
                            <p class="bottom-bottom-left">SPIX industry a été créée pour développer l’utilisation de la VOIX dans l’industrie sous toutes ses formes : pilotage vocal de logiciels
                                existants, assistance conversationnelle avancée pour guider les opérateurs sur leurs procédures, remplissage par la voix de formulaire « yeux et mains
                                libres », transcription temps réel ou différé de notes audio, co-développement d’applications métier intégrant nativement un Assistant Vocal Intelligent.
                                SPIX industry a participé au programme Confiance.ai afin de définir/affiner les conditions socio-techniques d'adoption d'un assistant vocal dans l'industrie.</p>
                            <p class="bottom-bottom-right">Constructeur automobile depuis 1898, Renault est leader du marché automobile français. L'entreprise a souhaité se joindre au
                                programme Confiance.ai afin de proposer un terrain d'expérimentation permettant de faire émerger les conditions socio-techniques d'adoption d'un assistant
