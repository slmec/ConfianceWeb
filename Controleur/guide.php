    ...
    <section>
        <div class="container">
            ...
            <div class="guide">
                ...
                <ul>
                    <li> Pour que le diagnostic soit totalement représentatif il faut que le participant réponde de façon honnête à toutes les questions.</li>
                </ul>
                <h3>Comment analyser vos resultats ?</h3>
                <ul>
                    <li>Les résultats se composent de deux parties :</li>
                    <li>1 - Avec un diagramme radar dit diagramme en toile d’araignée où les critères sont indiquées autour du graphique (axes des X). Les notes de chaque critère sont affichées à l'intérieur de la toile (axe des Y). Des segments de droite (lignes) relient les données d'une série, formant un polygone.</li>
                    <li>2 - Avec des implications qui mettent en lumières des points de vigilance en fonction de vos réponses.</li>
                    <br>
                    <li>Si vous êtes connecté pour réaliser le diagnostic, vous avez aussi la possibilité d’ajouter une analyse personnelle directement à la suite de vos résultats pour chaque critère. Cette analyse se décompose autour d’une partie interprétation, d’un plan d’action et d’un suivi.</li>
                </ul>
                <h3> Comment revoir mes diagnostics ?</h3>
                <ul>
                    <li>Si vous avez un compte, il est possible de revoir et de comparer vos anciens résultats de diagnostic. Vous aurez accès à vos diagnostics et serez en mesure de comparer jusqu'à 3 diagnostics en même temps que ce soit sur le diagramme radar ou au niveau des implications.</li>
                </ul>
            </div>
        </div>
        <footer>
